...
# Load the JSON file
with open("../preservr_data_visualization/test_data/recommended_topics.json", "r", encoding="utf-8") as file:
    data = json.load(file)
...
output_path = "../preservr_data_visualization/images/top_topics.png"
